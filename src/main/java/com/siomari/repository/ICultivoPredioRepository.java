...
public interface ICultivoPredioRepository extends JpaRepository<CultivoPredio, Integer> {
	...
	/**
	 * se buscaran el cultivoPredio el cual coincida con el predio y el plan de siembra
	 * 
	 * @param predio
	 *            id del predio
	 * @param planSiembra
	...
	List<CultivoPredio> buscarPorPredioIdPlanSiembraId(@Param("predio") int predio, @Param("planSiembra") int planSiembra);
	
	
	
	/**
	 * se listaran las hectareas que se sembraran de un determinado cultivo en cada periodo en un año determinado y entre
	 * meses especificados
	 * 
	 * @param cultivo id del cultivo
	 * @param year año
	 * @param min rango inferior del mes que se quiere consultar
	 * @param max rango superior del mes que se quiere consultar
